...
![dbdiagram](/readme_content/images/storychain.png)
...
* In your IDE, create a file containing your environmental variables called env.py at the root level of the application. It will need to contain the following lines and variables:
    ...
    Tip for your SECRET_KEY, you can use a Password Generator in order to have a secure secret key. I personlly recommend a length of 24 characters and exclude Symbols.
